...
<div id="header">
    <div class="container">
        <h1><a href="<?php echo UpMvc\Container::get()->site_path ?>"><?php _e(UpMvc\Container::get()->site_name) ?></a></h1>
        ...
        <div id="menu">
            <ul>
                <?php foreach($categories as $key => $value): ?>
                    <li>
                        <a href="<?php echo UpMvc\Container::get()->site_path ?>/Category/show/<?php echo $value['id'] ?>"><?php _e($value['name']) ?></a>
